...
export function Back({ width = 48, height = 48, fill = "black" }) {
  return (
    <svg
    ...
    >
      <path
        fill={fill}
        d="M58.91 38.23H35.52l8.84-8.84a3.49 3.49 0 1 0-4.93-4.94l-14.8 14.8a3.5 3.5 0 0 0 0 4.94L39.43 59a3.49 3.49 0 0 0 4.93-4.94l-8.84-8.83h23.39a3.49 3.49 0 0 0 0-7Z"
      ></path>
    </svg>
  );
}
...
export function MapMarker({ width = 27, height = 27, ...props }) {
  return (
